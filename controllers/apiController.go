...
func (a *APIController) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "GET":
		...
		des = des || pathDyn("/subject/GetSubjectsByTag/:tag", elements, params, api.GetSubjectByTag, w, r)
		...
		des = des || pathDyn("/post/GetPostsByTag/:tag", elements, params, api.GetPostByTag, w, r)
